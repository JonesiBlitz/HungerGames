...
public class SBDisplay {
  ...
  public SBDisplay(Game game) {
    ...
    this.ob =
        board.registerNewObjective(
            ChatColor.translateAlternateColorCodes('&', HG.getPlugin().getLang().players_alive),
            "dummy",
            "arena" + game.getGameArenaData().getName());
    this.ob.setDisplaySlot(DisplaySlot.SIDEBAR);
    this.ob.setDisplayName(
        ChatColor.translateAlternateColorCodes('&', HG.getPlugin().getLang().scoreboard_title));
    this.game = game;
  }
  ...
  public void setAlive() {
    ...
    Score arena = ob.getScore(ChatColor.translateAlternateColorCodes('&', HG.getPlugin().getLang().scoreboard_arena
    + g.getName()));
    ...
    String alive =
        "  "
            + HG.getPlugin()
                .getLang()
                .players_alive_num
                .replace("<num>", String.valueOf(game.getGamePlayerData().getPlayers().size()));
