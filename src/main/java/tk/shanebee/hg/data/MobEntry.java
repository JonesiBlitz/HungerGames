...
public class MobEntry {
   ...
   *
   * <p>This is the message players will see when a player is killed by this mob type
   *
  ...
  public void setDeathMessage(String message) {
    if (message != null) this.deathMessage = message;
  }
    ...
    if (!isMythic()) {
          ...
          .spawn(
              ...
              entity -> {
                ...
                if (entity instanceof LivingEntity) {
                  ...
                  if (hand != null) equip.setItemInMainHand(hand);
                  if (offHand != null) equip.setItemInOffHand(offHand);
                  if (helmet != null) equip.setHelmet(helmet);
                  if (chest != null) equip.setChestplate(chest);
                  if (leggings != null) equip.setLeggings(leggings);
                  if (boots != null) equip.setBoots(boots);
                  ...
                  if (deathMessage != null)
                    mob.setMetadata(
                        "death-message", new FixedMetadataValue(HG.getPlugin(), deathMessage));
                }
              });
    } else {
      ...
      if (deathMessage != null) {
        activeMob
            .getEntity()
            .getBukkitEntity()
            .setMetadata("death-message", new FixedMetadataValue(HG.getPlugin(), deathMessage));
      }
    }
  }
