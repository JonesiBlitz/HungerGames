 ...
 *
 * <p>Stores different stats for players in games including wins, deaths, kills and games played.
 */
...
public class Leaderboard {
   ...
   *
   * <p>Will match up with scores from {@link #getStatsScores(Stats)}
   *
   ...
   *
   * <p>Will match up with players from {@link #getStatsPlayers(Stats)}
   *
  ...
  private void loadLeaderboard() {
    ...
    getLeaderboard(
        "Games-Played", gamesPlayed, sorted_scores_gamesPlayed, sorted_players_gamesPlayed);
  }

  private void getLeaderboard(
      String path, Map<String, Integer> map, List<String> scores, List<String> players) {
  ...
  public enum Stats {
     ...
     *
     * <p>Only counted for a game a player has either won or died in. Leaving a game does not count
     */
    GAMES("games");
