...
public class Text {
   ...
   *
   * <p>Clicking the message will run a command
   *
   ...
   */
  public static TextComponent clickableCommand(
      @NotNull String message, @NotNull String command, Consumer<List<String>> hover) {
   ...
   *
   * <p>Message will be prefixed with the hunger games prefix
   *
